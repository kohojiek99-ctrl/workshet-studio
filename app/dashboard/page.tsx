...
export default function DashboardPage() {
  ...
  // Cek user login & ambil data real-time dari localStorage
  useEffect(() => {
    ...
    // Ambil data dari LocalStorage secara real-time
    try {
      ...
      // Ambil 3 project terbaru untuk bagian Recent Projects
    ...
    <div className="p-10 max-w-[1400px] mx-auto text-white">
      ...
      <div className="mb-10">
        ...
        <p className="text-gray-400">
          Welcome back! Semua data worksheet dan aset lu tersinkron secara real-time.
        </p>
      </div>

      {/* Kartu Statistik Real-Time (Sinkron dengan Data Asli) */}
      ...
      {/* Recent Projects Section (Dinamis & Berguna) */}
      <div className="bg-[#111424] border border-gray-800 rounded-2xl p-6">
